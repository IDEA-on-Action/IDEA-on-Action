...
**마지막 업데이트**: 2025-12-02
**현재 Phase**: v2.28.0 병렬 작업 Phase 1 완료
**다음 단계**: 5개 옵션 Phase 2 진행
**프로젝트 버전**: 2.27.0
**프로덕션**: https://www.ideaonaction.ai

---

## 🔄 진행 중: v2.28.0 병렬 작업 (2025-12-02)
...
| 옵션 | 다음 작업 | 상태 |
|------|----------|------|
| A. Central Hub | AlertSubscriptionManager UI | ⬜ |
| B. pptx Skill | usePptxGenerate 훅 | ⬜ |
| C. 테스트 | useClaudeSkill 테스트 | ⬜ |
| D. Minu 연동 | E2E 테스트 스크립트 | ⬜ |
| E. 번들 최적화 | @giscus lazy load | ⬜ |

### 품질 지표

| 지표 | 이전 | 이후 | 변화 |
|------|------|------|------|
| 유닛 테스트 | 971개 | 992개 | +21개 |
| 린트 에러 | 0개 | 0개 | 유지 |
