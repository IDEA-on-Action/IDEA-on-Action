...
Supabase 관련 문서 175개 파일, 73,000+ 줄 삭제.

#### 삭제된 폴더

| 폴더 | 내용 |
|------|------|
| `docs/guides/subscriptions/` | Edge Function 가이드 |
| `docs/guides/database/` | DB 마이그레이션 가이드 |
| `docs/guides/newsletter/` | 뉴스레터 가이드 |
| `docs/guides/services-platform/` | 서비스 플랫폼 가이드 |
| `docs/guides/storage/` | 스토리지 가이드 |
| `docs/guides/cms/` | CMS 가이드 |
| `docs/guides/auth/` | 인증 가이드 |
| `docs/guides/testing/` | 테스팅 가이드 |
| `docs/database/` | DB 스키마 문서 |
| `docs/deployment/` | 배포 가이드 |
| `docs/production-validation/` | 프로덕션 검증 |
| `docs/testing/` | 테스트 문서 |
| `docs/reports/` | 리포트 |

#### 누적 정리 현황 (v2.40.5 ~ v2.40.8)
