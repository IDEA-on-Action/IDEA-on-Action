...
### 접근성 (2025-11-19 업데이트)
- **명도 대비**: WCAG 2.1 AA 기준 100% 준수 ✅
  - Primary 버튼: 4.52:1 (AA)
  - Secondary 버튼: 16.30:1 (AAA)
  - Accent 텍스트: 9.38:1 ~ 11.82:1 (AAA)
- **포커스 표시**: 모든 인터랙티브 요소에 명확한 포커스 링
- **검증 도구**: [색상 대비 검증 스크립트](../../../scripts/check-color-contrast.cjs)
- **상세 가이드**: [접근성 가이드](./accessibility.md)
