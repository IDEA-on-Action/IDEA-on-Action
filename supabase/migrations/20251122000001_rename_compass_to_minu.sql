...
-- 기존 뷰가 있으면 새 이름으로 재생성
CREATE OR REPLACE VIEW public.minu_integration_view AS
SELECT
  u.id as user_id,
  u.email,
...
WHERE srv.category = 'minu' OR srv.category IS NULL;
...
/*
-- 서비스 원복
UPDATE services SET title = 'COMPASS Navigator', slug = 'navigator', category = 'compass' WHERE slug = 'find';
UPDATE services SET title = 'COMPASS Cartographer', slug = 'cartographer', category = 'compass' WHERE slug = 'frame';
UPDATE services SET title = 'COMPASS Captain', slug = 'captain', category = 'compass' WHERE slug = 'build';
UPDATE services SET title = 'COMPASS Harbor', slug = 'harbor', category = 'compass' WHERE slug = 'keep';
